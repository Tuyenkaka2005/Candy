...
const messages = [
  "Gửi đến người phụ nữ tuyệt vời nhất trong cuộc đời anh, em mang đến niềm vui và hạnh phúc cho anh mỗi ngày.",
  ...
  "Em không chỉ là người anh yêu mà còn là người bạn tâm giao và là tất cả của anh.",
  "Anh trân trọng từng khoảnh khắc chúng ta bên nhau, và anh mong muốn tạo ra nhiều kỷ niệm đẹp hơn nữa.",
  "Chúc Phương Thảo! Em xứng đáng có được tất cả hạnh phúc trên thế giới này.Cắn cắn cắn",
];
